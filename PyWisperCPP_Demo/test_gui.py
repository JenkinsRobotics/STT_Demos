...
class TranscriptionApp(QWidget):
    ...
    def initUI(self):
        ...
        self.decode_time_label = QLabel("Decode time: —")
        self.decode_time_label.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        self.decode_time_label.setContentsMargins(5, 2, 5, 2)
        bottom_bar = QHBoxLayout()
        bottom_bar.addWidget(self.status_bar_label)
        bottom_bar.addStretch()
        bottom_bar.addWidget(self.decode_time_label)
    ...
    def start_transcription(self):
        ...
        self.decode_time_label.setText("Decode time: —")
    ...
    def on_transcription_finished(self):
        ...
        if hasattr(self, 'transcription_start_time'):
            ...
            self.decode_time_label.setText(f"Decode time: {elapsed:.2f} sec")
